...
def chi_over_w():
    ...
    for ii in range(len(w)):
        chiw[ii] = Integration.integrater.int_disc(integrand[ii, :],
                                                   Integration.grids.equi(k[0], k[-1], len(k))) #gts1
        #alpha[ii] = Integration.integrater.int_disc(integrand2[ii, :],
        Integration.grids.gts1(k[0], k[-1], len(k))     
